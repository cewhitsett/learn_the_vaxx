...
reactions = {
    ...
    15: {"next": 2, "text": "The vaccine has adverse side effects, doesn’t it?"},
    16: {
        "next": 3,
        "text": "Don’t vaccines inject you with the virus in order to trigger your immune system?",
    },
    17: {"next": 4, "text": "It’s doubtful that the COVID vaccine will work well"},
    18: {
        "next": 5,
