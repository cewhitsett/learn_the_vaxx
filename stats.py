stats_info = {0: {'stat': '10%',
 ...
 2: {'stat': '300% to 400%',
  ...
  'link': 'https://www.cdc.gov/media/releases/2019/p0905-racial-ethnic-disparities-pregnancy-deaths.html'},
 3: {'stat': '42%',
 ...
 4: {'stat': '300%',
  'info': 'Black Americns are 3 times as likely to die from Covid than white Americans',
